...
namespace SmartDriverAPI.Helper
{
    ...
    public static class Utility
    {
        ...
        /// 
        /// </summary>
        public const int MinPacketLen = 22;
        /// <summary>
        /// 
        /// </summary>
        public const byte txtStartChar = (byte)'*';
        /// <summary>
        /// 
        /// </summary>
        public const char txtEndChar = '#';
        /// <summary>
        /// 
        /// </summary>
        public const byte binFlagChar = 0xF8;
        /// <summary>
        /// 
        /// </summary>
        public const byte binEscapeChar = 0xF7;
        /// <summary>
        /// 
        /// </summary>
        public const byte AckFlag = 0xFE;
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public static Int16 ReadInt16(byte[] dat, int pos)
        {
        ...
        /// <param name="pos"></param>
        /// <returns></returns>
        public static UInt16 ReadUint16(byte[] dat, int pos)
        {
            if (pos + 2 > dat.Length)
                return 0;
            UInt16 val = 0;
        ...
        /// <param name="pos"></param>
        /// <returns></returns>
        public static Int32 ReadInt32(byte[] dat, int pos)
        {
        ...
        /// <param name="pos"></param>
        /// <returns></returns>
        public static UInt32 ReadUint32(byte[] dat, int pos)
        {
            if (pos + 4 > dat.Length)
                return 0;
            UInt32 val = 0;
        ...
        /// <param name="pos"></param>
        /// <returns></returns>
        public static sbyte ReadSignedByte(byte[] dat, int pos)
        {
            if (pos + 1 > dat.Length)
                return 0;
        ...
        /// <param name="pos"></param>
        /// <returns></returns>
        public static byte ReadUnsignedByte(byte[] dat, int pos)
        {
            if (pos + 1 > dat.Length)
                return 0;
            return dat[pos];
        ...
        /// <returns></returns>
        public static UInt16 GetCrc16Value(byte[] dat, int length)
        {
        ...
        /// <returns></returns>
        public static byte[] binDataPacket(byte[] data)
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static byte[] DataBinAcknowledgement(byte[] data)
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static string DataTxtAcknowledgement(byte[] data)
        {
        ...
        /// <returns></returns>
        public static bool TextFrameFormatCheck(byte[] buffer, int first, int end)
        {
        ...
        /// 
        /// </summary>
        /// <param name="binFrame"></param>
        /// <returns></returns>
        public static int BinFrameFormatCheck(byte[] binFrame)
        {
            bool bEscape = false;
            int len = 0;
        ...
        public static DateTime GetDateTimeFromString(string str)
        {
            ...
            try
            {
                ...
                {
                    dt = new DateTime(
                        System.Convert.ToInt16(str.Substring(15, 2)) + 2000,
                        System.Convert.ToInt16(str.Substring(12, 2)),
                        System.Convert.ToInt16(str.Substring(9, 2)),
                        System.Convert.ToInt16(str.Substring(0, 2)),
                        System.Convert.ToInt16(str.Substring(3, 2)),
